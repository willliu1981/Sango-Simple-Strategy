...
- 42 座城池的全國戰略地圖，可拖曳、縮放、定位與全螢幕查看。
- 城池內政包含農業、商業、治水、城防、訓練、徵兵與安民。
- 金、糧由勢力共用；人口、訓練、士氣、民心與城防由各城管理。
- 偵察敵情、運兵增援、單城出征與多城聯合作戰，並以「強攻、誘敵、固守」形成攻守相剋。
...
1. 在戰略地圖查看劇本目標、城池、道路、情報與勢力資源。
2. 進入我方城池發展內政、訓練、徵兵或安民。
3. 視局勢偵察敵城、運兵增援，或由一座及多座城池出征。
4. 安排完成後結束月份，統一結算收入、軍糧、行軍、戰鬥、災害與敵軍行動。
