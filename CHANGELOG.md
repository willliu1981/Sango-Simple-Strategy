...
- 偵察成功後可查看敵城當時的防守方針，並可點擊敵方勢力名稱查看依已掌握情報推估的金、糧、兵力與下月行動力。
- 城池內政畫面顯示勢力共用金、糧；徵兵確認畫面顯示扣除後剩餘金、糧，按鈕文案統一為操作名稱與費用。
- 天下戰報改為列出最新月份全部戰事，同月我方戰事優先；各城戰報仍只保留該城最近一次戰鬥。
- 整理偵察與內政畫面版面，修正資訊重疊與未讀戰報顯示範圍。
